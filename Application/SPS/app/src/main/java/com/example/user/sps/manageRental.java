...
public class manageRental extends AppCompatActivity implements View.OnClickListener {
   ...
   // Httpresponse3 httpresponse3;
    private final String s = "http://172.20.10.3/uml3.php"; //
    private final String s3 = "http://172.20.10.3/uml6.php";
    private final String s2 = "http://172.20.10.3/uml6.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_rental);
   ...
   //     httpresponse3 = new Httpresponse3(this);
        ...
        para.put("id", "sps1");         //사용자 이름 sps1로 지정
...
//        client3.post(s3, para, httpresponse3);
        ...
        Button buttSearch = (Button) findViewById(R.id.buttSearch);
        buttSearch.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(manageRental.this, category.class);
 ...
 @Override
    ...
    private class Httpresponse extends AsyncHttpResponseHandler {
        ...
        public void onSuccess(String content) {
            ...
            Intent intent=new Intent(manageRental.this, detailRental.class);
